...
void TestManager::summary(void) const
{
    ...
    if ( n_successful != 0 ) std::cout << "[ "<< "PASSED" << "    ] " << n_successful << " tests.\n";
    if ( n_failed != 0 )     std::cout << "[ "<< "FAILED" << "    ] " << n_failed     << " tests.\n";
    if ( n_disabled != 0 )   std::cout << "[ "<< "DISABLED" << "  ] " << n_disabled   << " tests.\n";
    if ( n_undefined != 0 )  std::cout << "[ "<< "UNDEFINED" << " ] " << n_undefined  << " tests.\n";
#else
